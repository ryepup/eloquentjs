 ...
 * two-dimensional space. It takes x and y parameters (numbers), which
 * it should save to properties of the same name.
 *
 * Give the Vector prototype two methods, plus and minus, that take
 * another vector as a parameter and return a new vector that has the
 * sum or difference of the two vectors’ (the one in this and the
